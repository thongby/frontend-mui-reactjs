...
type DispensingAndDrugValueOPDHospitalChartProps = {
  //
};

const DispensingAndDrugValueOPDHospitalChart: React.FC<any> = () => {
...
export default DispensingAndDrugValueOPDHospitalChart;
